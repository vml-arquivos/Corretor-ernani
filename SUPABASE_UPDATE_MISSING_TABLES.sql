-- ============================================
-- SCRIPT DE ATUALIZAÇÃO - TABELAS FALTANTES
...
DO $$ BEGIN
  ALTER TABLE leads ADD COLUMN source source_enum DEFAULT 'site';
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;

DO $$ BEGIN
  ALTER TABLE leads ADD COLUMN priority priority_enum DEFAULT 'media';
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;

DO $$ BEGIN
  ALTER TABLE leads ADD COLUMN qualification qualification_enum DEFAULT 'frio';
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;

DO $$ BEGIN
  ALTER TABLE leads ADD COLUMN "buyerProfile" buyer_profile_enum;
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;

DO $$ BEGIN
  ALTER TABLE leads ADD COLUMN "urgencyLevel" urgency_level_enum DEFAULT 'media';
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;

DO $$ BEGIN
  ALTER TABLE leads ADD COLUMN "transactionInterest" transaction_interest_enum;
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;

DO $$ BEGIN
  ALTER TABLE leads ADD COLUMN "budgetMin" DECIMAL(15, 2);
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;

DO $$ BEGIN
  ALTER TABLE leads ADD COLUMN "budgetMax" DECIMAL(15, 2);
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;

DO $$ BEGIN
  ALTER TABLE leads ADD COLUMN "preferredLocations" TEXT;
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;
...
DO $$ BEGIN
  ALTER TABLE leads ADD COLUMN "updatedAt" TIMESTAMP DEFAULT NOW();
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;

DO $$ BEGIN
  ALTER TABLE leads ADD COLUMN "lastContactDate" TIMESTAMP;
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;
...
DO $$ BEGIN
  ALTER TABLE blog_posts ADD COLUMN "categoryId" INTEGER;
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;

DO $$ BEGIN
  ALTER TABLE blog_posts ADD COLUMN "publishedAt" TIMESTAMP;
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;

DO $$ BEGIN
  ALTER TABLE blog_posts ADD COLUMN "updatedAt" TIMESTAMP DEFAULT NOW();
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;
...
DO $$ BEGIN
  ALTER TABLE rentals ADD COLUMN "tenantEmail" VARCHAR(320);
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;

DO $$ BEGIN
  ALTER TABLE rentals ADD COLUMN "tenantPhone" VARCHAR(20);
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;

DO $$ BEGIN
  ALTER TABLE rentals ADD COLUMN "tenantCpf" VARCHAR(14);
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;

DO $$ BEGIN
  ALTER TABLE rentals ADD COLUMN "commissionPercentage" DECIMAL(5, 2) DEFAULT 10.00;
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;

DO $$ BEGIN
  ALTER TABLE rentals ADD COLUMN "endDate" DATE;
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;

DO $$ BEGIN
  ALTER TABLE rentals ADD COLUMN "dueDay" INTEGER CHECK ("dueDay" >= 1 AND "dueDay" <= 31);
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;
...
DO $$ BEGIN
  ALTER TABLE rentals ADD COLUMN "createdAt" TIMESTAMP DEFAULT NOW();
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;

DO $$ BEGIN
  ALTER TABLE rentals ADD COLUMN "updatedAt" TIMESTAMP DEFAULT NOW();
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;
...
DO $$ BEGIN
  ALTER TABLE rental_payments ADD COLUMN "paidDate" DATE;
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;

DO $$ BEGIN
  ALTER TABLE rental_payments ADD COLUMN "paymentMethod" payment_method_enum;
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;

DO $$ BEGIN
  ALTER TABLE rental_payments ADD COLUMN notes TEXT;
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;

DO $$ BEGIN
  ALTER TABLE rental_payments ADD COLUMN "createdAt" TIMESTAMP DEFAULT NOW();
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;

DO $$ BEGIN
  ALTER TABLE rental_payments ADD COLUMN "updatedAt" TIMESTAMP DEFAULT NOW();
EXCEPTION
  WHEN duplicate_column THEN null;
END $$;
